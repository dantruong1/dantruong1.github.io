        ...
        <Card className="p-7 md:p-9 bg-card dark:bg-night-card border-espresso/8 dark:border-night-border relative overflow-hidden flex-1 flex flex-col justify-between shadow-cozy">
          ...
          <div className="flex flex-wrap gap-2.5 pt-4 border-t border-espresso/8 dark:border-night-border">
            <button
              ...
              className="text-xs font-mono text-matcha-dark dark:text-matcha-glow bg-matcha-soft dark:bg-matcha-dark/40 hover:bg-matcha-light px-4 py-2 rounded-full flex items-center gap-1.5 transition-all duration-200 hover:shadow-sm"
            >
            ...
            <button
              ...
              className="text-xs font-mono text-espresso-muted dark:text-night-muted hover:text-espresso dark:hover:text-night-text bg-card-alt dark:bg-night-card-alt hover:bg-parchment-dark px-4 py-2 rounded-full transition-all duration-200 border border-espresso/5 dark:border-night-border"
            >
              Read Essays & Op-Eds
            </button>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs font-mono text-terracotta dark:text-terracotta-glow hover:text-terracotta bg-terracotta-soft/50 dark:bg-terracotta/30 hover:bg-terracotta-soft px-4 py-2 rounded-full transition-all duration-200"
            >
              LinkedIn ↗
            </a>
          </div>
